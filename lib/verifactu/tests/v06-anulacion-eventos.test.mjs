...
// tests (el XSD exige ds:Signature): la firma XAdES real NO se implementa en v1
// (DEC-V14, docs/verifactu/DECISIONES.md) y el generador NUNCA la inventa
// (sin firmaXmlDs el XML sale sin firma).
